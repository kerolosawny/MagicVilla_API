    ...
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> UpdateVillaNumber(int VillaNo)
        {
            ...
            if (response != null && response.IsSuccess)
            {
                ...
                //villaNumberUpdateVM.VillaNumber = JsonConvert.DeserializeObject<VillaNumberUpdateDTO>(Convert.ToString(response.Result));
            }
        ...
        {
            VillaNumberDeleteVM villaNumberUpdateVM = new VillaNumberDeleteVM();
